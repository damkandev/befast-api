function updateTable() {
  $.ajax({
    url: "http://localhost:8000/api/apoderadossup",
    type: "GET",
...
$("#crearEstudianteBtn").click(async () => {
  ...
  var response = await $.ajax({
    url: "http://localhost:8000/api/apoderadosup/",
    type: "POST",
    contentType: "application/json; charset=utf8",
...
function btnVer() {
  ...
  $.ajax({
    url: `http://localhost:8000/api/apoderadosup/${id}`,
    type: "GET",
    contentType: "application/json ; charset=utf8",
    dataType: "json",
    success: (response) => {
      localStorage.setItem("idapoderadosup", response.idapoderado);
...
function btnEditarModal() {
  var id = localStorage.getItem("idapoderadosup");
  ...
  function btnBorrar() {
    ...
    $.ajax({
      url: `http://127.0.0.1:8000/api/apoderadosup/${id}`,
      type: "DELETE",
      data: JSON.stringify(datos),
      contentType: "application/json ; charset=utf8",
      dataType: "json",
